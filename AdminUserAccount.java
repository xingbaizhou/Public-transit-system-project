...
public class AdminUserAccount {
     ...
     */
    AdminUserAccount(String username, String email) {
  ...
  public double getCost() {
     ...
     */
  void dailyReport(int date) {
    double sub = calculateDailySubRevenue(date);
    double bus = calculateDailyBusRevenue(date);
    System.out.println("The amount of all Subway revenue on " + date + " is " + sub);
    System.out.println("The amount of all Bus revenue on " + date + " is " + bus);
    System.out.println("The total amount of revenue on " + date + " is " + (bus + sub));
  }
